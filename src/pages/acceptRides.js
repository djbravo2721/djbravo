...
import { Theme, Link, Text, Input, Box, Button, Section, Image, LinkBox } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"accept-rides"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
		...
		>
			<Override slot="SectionContent" align-self="stretch" flex-direction="column-reverse" align-items="stretch" />
			<Box margin="-16px -16px -16px -16px" flex-wrap="wrap" display="flex">
		...
		<RawHtml>
			<style place={"endOfHead"} rawKey={"65356417cd81ee001f7e15eb"}>
